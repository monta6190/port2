...
const sidebarContent = [
  { icon: "home", itemName: "Accueil", itemRoute: "#home", activeClass: "active" },
  { icon: "human", itemName: "A propos", itemRoute: "#about", activeClass: "" },
  {
    icon: "service",
    itemName: "Service",
    itemRoute: "#service",
  ...
  { icon: "blog", itemName: "Skills", itemRoute: "#blog", activeClass: "" },
  {
    icon: "contact",
    itemName: "Contactez-moi",
    itemRoute: "#contact",
    activeClass: "",
  },
];
...
const sidebarFooterContent = {
  ...
  name: "Oumayma",
  email: "oumaymaycb@gmail.com",
  emailRef: "mailto:oumaymaycb@gmail.com",
};
